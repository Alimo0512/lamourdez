...
const designers = [
  {
    name: 'Zolique',
    founder: 'Founder of Zolique fashion\'s choices',
    ...
    img: './images/zolique.jpeg',
    alt: 'Zolique photo',
  },
  {
    name: 'Bruno Garcia',
    founder: 'Founder of Bruno G outfits',
  ...
  {
    name: 'Kate Norman',
    founder: 'Founder of All in One style',
  ...
  {
    name: 'Piere Joan',
    founder: 'Founder of Mviut Outfits',
  ...
  {
    name: 'Olivia Hanssen',
    founder: 'Founder of Olivia\'s Styles',
  ...
  {
    name: 'Roqque Liandro',
    founder: 'Founder of Fluid beauty collection',
    text: 'He sets the tone whether he is sitting in the front row or organising his own show with his brand, created with LVMH.',
    img: './images/roqque.jpeg',
    alt: 'Rihanna',
  },
];
